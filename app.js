...
function loadReadState() {
    try {
        const raw = JSON.parse(localStorage.getItem(READ_STATE_STORAGE_KEY) || "{}");
...
function updateThemeToggleLabel() {
    ...
    themeToggleButton.textContent = currentTheme === "light" ? "Modo noturno" : "Modo claro";
    themeToggleButton.setAttribute("aria-label", currentTheme === "light" ? "Ativar modo noturno" : "Ativar modo claro");
}
